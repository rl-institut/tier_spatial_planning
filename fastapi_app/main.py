...
async def optimize_grid(optimize_grid_request: models.OptimizeGridRequest,
    ...
    print(f"number of relaxation steps: {number_of_relaxation_steps_nr}")
    opt.nr_optimization(grid=grid, number_of_hubs=number_of_hubs, number_of_relaxation_steps_nr=number_of_relaxation_steps_nr,
