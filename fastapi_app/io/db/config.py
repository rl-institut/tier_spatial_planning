...
MAIL_ADRESS_LOGGER = 'gAAAAABkm-nPFnh8LDlwsgnpZehRqkSlieqZIuB2lp7xatcSvFlj4fp_4l5TkugFJ-D44uRffagTMmcSRw_u_M6m_y5jJw1Yjw_qQ-1TiM3Pc9gEAos9TeI='
...
if os.environ.get('PW') is not None:
    ...
    with open(os.environ['PW']) as file:
        ...
        MAIL_ADRESS_LOGGER = crypt.decrypt(MAIL_ADRESS_LOGGER)
    ...
    from fastapi_app.io.db.dev_config import db_host, db_name, db_user_name, PW, MAIL_PW, SALT, \
        ...
        KEY_FOR_TOKEN, TOKEN_ALG, MAIL_ADRESS, MAIL_ADRESS_LOGGER
db_port = 3306
